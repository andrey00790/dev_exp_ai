    ...
    def test_search_workflow_e2e(self):
        ...
        with patch('requests.post', return_value=mock_response):
            response = requests.post(
                f"{E2E_BASE_URL}/api/v1/search/advanced/",
                json=search_request
            )
    ...
    def test_protected_endpoint_access_e2e(self):
        ...
        with patch('requests.get', return_value=mock_response):
            response = requests.get(
                f"{E2E_BASE_URL}/api/v1/users/me",
                headers=headers
            )
    ...
    def test_document_upload_and_search_e2e(self):
        ...
        with patch('requests.post', return_value=mock_upload_response):
            upload_response = requests.post(
                f"{E2E_BASE_URL}/api/v1/documents/",
                json=upload_data
            )
...
class TestE2EIntegration:
    ...
    def test_full_system_integration_e2e(self):
        ...
        with patch('requests.post') as mock_post, patch('requests.get') as mock_get:
            ...
            upload_response = requests.post(f"{E2E_BASE_URL}/api/v1/documents/", json={})
            search_response = requests.post(f"{E2E_BASE_URL}/api/v1/search/advanced/", json={})
