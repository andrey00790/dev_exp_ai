...
from models.documentation import (
    DocumentationRequest, DocumentationResponse, CodeAnalysisRequest,
    GeneratedDocumentation, CodeAnalysis, DocumentationSection,
    CodeFile, CodeRepository, CodeLanguage, DocumentationType,
...
class DocumentationService(DocumentationServiceInterface):
    ...
    async def generate_documentation(self, request: DocumentationRequest) -> DocumentationResponse:
        ...
        try:
            ...
            documentation = await self._generate_documentation_with_llm(request, code_analysis)
    ...
    async def _perform_code_analysis(self, code_input: Union[CodeFile, CodeRepository, str]) -> CodeAnalysis:
    ...
    def _detect_language_from_content(self, code: str) -> CodeLanguage:
        ...
        java_patterns = [
            ...
            'public static void main', 'import java', 'extends ', 'implements '
        ]
    ...
    def _check_python_performance(self, code: str) -> List[str]:
        ...
        if '.append(' in code and 'for ' in code:
            notes.append('Рассмотрите использование list comprehension для лучшей производительности')
    ...
    async def _generate_documentation_with_llm(
        ...
        try:
            ...
            # Парсим результат
            documentation = self._parse_llm_documentation(doc_content, request, code_analysis)
    ...
    def _prepare_llm_context(self, request: DocumentationRequest, analysis: CodeAnalysis) -> str:
    ...
    def _parse_llm_documentation(
        ...
        title = title_match.group(1) if title_match else f"Документация ({request.documentation_type.value})"
