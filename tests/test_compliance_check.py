...
class TestFunctionalRequirements:
    ...
    def test_fr_063_websocket(self):
        ...
        websocket_routes = [route for route in app.routes if hasattr(route, 'path') and route.path == "/ws/{user_id}"]
...
class TestArchitectureCompliance:
    ...
    def test_api_structure(self):
        ...
        v1_routes = [route for route in app.routes if hasattr(route, 'path') and route.path.startswith("/api/v1")]
