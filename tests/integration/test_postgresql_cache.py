...
class TestPostgreSQLCache:
    ...
    def test_cache_expiration(self, cache_client):
        ...
        try:
            ...
            set_result = cache_client.set('expiring_key', 'expiring_value', ttl_seconds=1)
            if not set_result:
            ...
            assert expiration_worked, f"TTL expiration didn't work. Value: {expired_value}, Cleaned: {cleaned_count}"
