...
class WebSocketManager:
    ...
    async def connect(self, websocket: WebSocket, user_id: str, connection_info: Dict[str, Any] = None):
    ...
    async def broadcast_system_notification(
        ...
        logger.info(f"Broadcast sent: {sent_count} successful, {failed_count} failed/queued")
    ...
    async def send_task_notification(
        ...
        notification_type = status_mapping.get(task_status, NotificationType.TASK_PROGRESS)
    ...
    async def cleanup_offline_messages(self, max_age_hours: int = 24):
        ...
        logger.info(f"Cleaned up {cleaned_count} offline messages older than {max_age_hours} hours")
