# ECS Task Definitions and Services for AI Assistant MVP
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        {
          name  = "CORS_ORIGINS"
          value = var.domain_name != null ? "https://${var.domain_name},https://www.${var.domain_name}" : "*"
        }
      ]
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        },
        {
          ...
          value = var.domain_name != null ? "wss://${var.domain_name}/ws" : "ws://${aws_lb.main.dns_name}/ws"
        }
      ]
...
resource "aws_appautoscaling_target" "backend" {
  ...
  tags = {
    Name = "${var.project_name}-backend-autoscaling-target"
  }
}
...
resource "aws_appautoscaling_target" "frontend" {
  ...
  tags = {
    Name = "${var.project_name}-frontend-autoscaling-target"
  }
}
