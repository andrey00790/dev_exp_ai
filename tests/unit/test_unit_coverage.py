    ...
    def test_document_from_jira_issue(self):
        ...
        issue_data = {
            ...
            "fields": {
                ...
                "project": {"key": "TEST"},
                "creator": {"displayName": "Creator", "emailAddress": "creator@test.com"},
...
class TestUtilityFunctions:
    ...
    def test_calculate_source_breakdown(self):
        ...
        from app.api.v1.search_advanced import _calculate_source_breakdown
    ...
    def test_calculate_quality_stats(self):
        ...
        from app.api.v1.search_advanced import _calculate_quality_stats
    ...
    def test_calculate_time_range(self):
        ...
        from app.api.v1.search_advanced import _calculate_time_range
...
class TestAPIValidation:
    ...
    def test_source_filter_validation(self):
        ...
        from app.api.v1.search_advanced import SourceFilter
        
        filter_obj = SourceFilter(
            confluence=["space1", "space2"],
            jira=["project1"],
            gitlab=["repo1"]
        )
...
class TestAnalyticsFunctions:
    ...
    def test_usage_aggregation(self):
        ...
        assert abs(aggregated["user1"]["cost"] - 0.3) < 0.001  # Учитываем погрешность float
