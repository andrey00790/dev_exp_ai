    ...
    try:
        ...
        if usage_percentage >= 80:
            mock_alerts.append({
                ...
                "resolved_at": None if usage_percentage >= 80 else "2025-06-16T22:00:00Z"
            })
...
async def get_budget_overview(
    ...
    try:
        ...
        total_budget = sum(user.get("budget_limit", 100.0) for user in USERS_DB.values())
        ...
        return {
            ...
            "alerts": {
                ...
                "users_over_95_percent": len([u for u in warning_users if u["percentage"] >= 95]),
                "users_exceeded": len([u for u in warning_users if u["percentage"] >= 100])
            },
