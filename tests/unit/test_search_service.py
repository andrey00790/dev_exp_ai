...
class TestSearchService:
    ...
    async def test_pagination(self, search_service):
        ...
        # Первая страница
        page1 = await search_service.search_documents(
            query="test",
            limit=2,
            offset=0
        )
        ...
        # Вторая страница
        page2 = await search_service.search_documents(
            query="test",
            limit=2,
            offset=2
        )
...
class TestSearchServiceWithBackend:
    ...
    @patch('services.search_service.get_backend_search_service')
...
class TestSearchFilters:
    ...
    async def test_date_range_filter(self, search_service):
        ...
        filters = {
            "updated_at_range": [start_date.isoformat(), end_date.isoformat()]
        }
