...
from app.core.exceptions import AsyncTimeoutError, AsyncResourceError, AsyncRetryError
...
class TestHttpClient:
    ...
    def test_http_client_factory(self):
        ...
        from app.core import http_client_factory, api_client, internal_service_client
        ...
        service_client = internal_service_client("test-service", "http://localhost:8080")
...
class TestIntegrationAsyncPatterns:
    ...
    async def test_cache_manager_async_patterns(self):
        ...
        from app.performance.cache_manager import cache_manager, get_cache, set_cache
...
class TestAsyncPerformance:
    ...
    async def test_with_timeout_overhead(self):
        ...
        assert overhead < 2.0, f"Timeout overhead too high: {overhead:.2%} (direct: {direct_time:.3f}s, timeout: {timeout_time:.3f}s)"
