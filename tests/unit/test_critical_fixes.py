...
class TestCriticalFixes:
    ...
    def test_ai_optimization_service_works(self):
        ...
        from app.services.ai_optimization_service import AIOptimizationService, ModelType
    ...
    def test_auth_protected_endpoints_respond(self):
        ...
        endpoints_to_test = [
            ("POST", "/ai-optimization/optimize", {"model_type": "code_review", "optimization_type": "performance"}),
