...
from models.document import (CommonFilters, Document, DocumentChunk,
                             DocumentStatus, SearchFilter, SourceType)
...
class TestDocument:
    ...
    def test_from_gitlab_file(self):
        ...
        assert (
            doc.source_url == "https://gitlab.com/project/blob/main/src/auth/README.md"
        )
...
class TestDocumentIntegration:
    ...
    def test_search_filter_with_document(self, sample_document):
        ...
        non_matching_filter = (
            SearchFilter().by_source_type(["jira"]).by_category(["code"]).build()
        )
