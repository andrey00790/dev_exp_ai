...
from fastapi import APIRouter, Depends, HTTPException, Request, Response, Query, Form, status
from fastapi.responses import RedirectResponse, JSONResponse
from sqlalchemy.orm import Session
from pydantic import BaseModel, Field

from ...database import get_db
from ...security.sso.sso_manager import SSOManager
from ...security.sso.models import SSOProviderType
...
async def saml_acs(
    ...
    try:
        user_data, access_token = await sso_manager.handle_saml_acs(provider_id, request, db)
