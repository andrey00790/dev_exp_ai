...
async def load_test_endpoint(endpoint: str, concurrent_users: int = 50, requests_per_user: int = 10):
    """Test a specific endpoint with concurrent load"""
    print(f"🚀 Testing {endpoint} with {concurrent_users} users, {requests_per_user} req/user")
