...
from models.documentation import (
    ...
    CodeAnalysis, DocumentationType, CodeLanguage, CodeFile,
    DOCUMENTATION_CAPABILITIES
)
from models.base import BaseResponse
from services.documentation_service import DocumentationServiceInterface, get_documentation_service
...
async def generate_documentation(
    ...
    try:
        ...
        logger.info(f"Generated {request.documentation_type.value} documentation successfully")
        return result
...
async def analyze_code(
    ...
    try:
        ...
        logger.info(f"Code analysis completed: {len(result.functions)} functions, {len(result.classes)} classes found")
        return result
