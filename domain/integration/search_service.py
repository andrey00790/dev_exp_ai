...
try:
    from backend.search_service import SearchService as BackendSearchService
    from backend.search_service import \
        get_search_service as get_backend_search_service
...
class SearchServiceInterface(ABC):
    ...
    async def upload_document(
        self, file: UploadFile, file_type, request
    ) -> Dict[str, Any]:
...
class SearchService(SearchServiceInterface):
            ...
            results.append(
                {
                    ...
                    "hierarchy": {"space_key": "TECH", "project_key": None},
                    "categorization": {
                        "document_type": "page",
                    ...
                    "status": {"quality_score": 0.9, "relevance_score": 0.85},
                    "score": 0.9 - (i * 0.1),
    ...
    async def semantic_search(self, query) -> List[Dict[str, Any]]:
        ...
        result = await self.search_documents(
            query=query, search_type="semantic", limit=10
        )
