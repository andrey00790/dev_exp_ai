...
from app.api.v1.data_sources import router, initialize_sync_scheduler, shutdown_sync_scheduler
...
class TestDataSourcesAPI:
    ...
    def test_get_data_sources_success(self, mock_scheduler, mock_auth, client, mock_user):
    ...
    @patch('app.api.v1.data_sources.get_current_user')
    @patch('app.api.v1.data_sources.sync_scheduler')
    def test_get_data_sources_scheduler_unavailable(self, mock_scheduler, mock_auth, client, mock_user):
    ...
    @patch('app.api.v1.data_sources.get_current_user')
    @patch('app.api.v1.data_sources.sync_scheduler')
    def test_create_data_source_success(self, mock_scheduler, mock_auth, client, mock_user):
    ...
    @patch('app.api.v1.data_sources.get_current_user')
    @patch('app.api.v1.data_sources.sync_scheduler')
    def test_create_data_source_already_exists(self, mock_scheduler, mock_auth, client, mock_user):
    ...
    @patch('app.api.v1.data_sources.get_current_user')
    @patch('app.api.v1.data_sources.sync_scheduler')
    def test_update_data_source_success(self, mock_scheduler, mock_auth, client, mock_user):
        ...
        response = client.put("/api/v1/data-sources/confluence/main", json=updated_source)
    ...
    @patch('app.api.v1.data_sources.get_current_user')
    @patch('app.api.v1.data_sources.sync_scheduler')
    def test_update_data_source_not_found(self, mock_scheduler, mock_auth, client, mock_user):
        ...
        response = client.put("/api/v1/data-sources/confluence/nonexistent", json=updated_source)
    ...
    @patch('app.api.v1.data_sources.get_current_user')
    @patch('app.api.v1.data_sources.sync_scheduler')
    def test_get_sync_status_success(self, mock_scheduler, mock_auth, client, mock_user):
...
class TestSearchSourcesAPI:
    ...
    def test_get_user_search_sources_with_config(self, mock_available, mock_config, mock_auth, client, mock_user):
    ...
    @patch('app.api.v1.data_sources._get_user_search_config')
    @patch('app.api.v1.data_sources._get_available_sources')
    def test_get_user_search_sources_default(self, mock_available, mock_config, mock_auth, client, mock_user):
    ...
    def test_update_user_search_sources_success(self, mock_save, mock_available, mock_auth, client, mock_user):
        ...
        response = client.put("/api/v1/data-sources/search-sources/test_user_123", json=config_update)
    ...
    @patch('app.api.v1.data_sources.get_current_user')
    @patch('app.api.v1.data_sources._get_available_sources')
    def test_update_user_search_sources_invalid_sources(self, mock_available, mock_auth, client, mock_user):
...
class TestGenerationSourcesAPI:
    ...
    def test_update_generation_sources_success(self, mock_save, mock_auth, client, mock_user):
        ...
        response = client.put("/api/v1/data-sources/generation-sources", json=config_update)
...
class TestDataSourcesIntegration:
    ...
    def test_full_source_lifecycle(self, mock_scheduler, mock_auth, client, mock_user):
        ...
        sync_response = client.post("/api/v1/data-sources/confluence/test_confluence/sync")
        ...
        update_response = client.put("/api/v1/data-sources/confluence/test_confluence", json=updated_source)
        assert update_response.status_code == 200
        
        # 5. Отключение источника (удаление)
        delete_response = client.delete("/api/v1/data-sources/confluence/test_confluence")
    ...
    def test_search_preferences_workflow(self, mock_auth, client, mock_user):
        ...
        with patch('app.api.v1.data_sources._get_user_search_config') as mock_get_config, \
             patch('app.api.v1.data_sources._get_available_sources') as mock_available, \
             patch('app.api.v1.data_sources._save_user_search_config') as mock_save:
            ...
            get_response = client.get("/api/v1/data-sources/search-sources/test_user_123")
            ...
            update_response = client.put("/api/v1/data-sources/search-sources/test_user_123", json=config_update)
            assert update_response.status_code == 200
