...
from models.base import Document, SearchQuery, SearchResult, DocumentType
...
class DocumentServiceInterface(ABC):
    ...
    @abstractmethod
    async def update_document(self, document_id: str, document: Document) -> Optional[Document]:
        """Update document."""
        pass
