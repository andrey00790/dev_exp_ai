...
def test_metadata_fields_consistency():
    ...
    from models.document import Document, SourceType, DocumentStatus
...
def test_filter_application_to_documents():
    ...
    from models.document import Document, SearchFilter, SourceType, DocumentStatus
    ...
    confluence_filter = (SearchFilter()
