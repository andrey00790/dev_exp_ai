...
from services.data_sync_service import DataSyncService, get_data_sync_service
...
async def run_manual_sync(
    ...
    return {"message": f"Синхронизация для {request.source_type}:{request.source_name} запущена в фоновом режиме."}
...
async def run_startup_sync(
    ...
    return {"message": "Синхронизация при старте успешно запущена для всех пользователей."}
