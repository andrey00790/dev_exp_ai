#!/usr/bin/env python3
"""
Упрощенные интеграционные тесты для полнотекстового поиска в PostgreSQL
"""
...
class TestPostgreSQLSearchSimple:
    """Упрощенные тесты полнотекстового поиска в PostgreSQL"""
